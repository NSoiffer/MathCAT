...
mod functions {
    ...
    fn trig_names() {
        ...
        test("ClearSpeak", expr, "sine of x plus cosine of y plus tangent of z plus secant of alpha, plus co-secant of phi, plus co-tangent of phi");
    }
    ...
    fn hyperbolic_trig_names() {
        ...
        test("ClearSpeak", expr, "hyperbolic sine of x, plus \
    ...
    fn inverse_trig() {
        ...
        test("ClearSpeak", expr, "inverse sine of x");
    }
    ...
    fn trig_squared() {
        ...
        test("ClearSpeak", expr, "sine squared of x");
    }

    #[test]
    fn trig_cubed() {
        let expr = "<math><msup><mi>tan</mi><mn>3</mn></msup><mi>x</mi></math>";
        test("ClearSpeak", expr, "tangent cubed of x");
    }

    #[test]
    fn trig_fourth() {
        let expr = "<math><msup><mi>sec</mi><mn>4</mn></msup><mi>x</mi></math>";
        test("ClearSpeak", expr, "the fourth power of, secant of x");
    }
    ...
    fn trig_power_other() {
        ...
        test("ClearSpeak", expr, "the n minus 1 power of, hyperbolic sine of x");
    }

    #[test]
    fn simple_log() {
        let expr = "<math> <mrow>  <mi>log</mi><mi>x</mi></mrow> </math>";
        test("ClearSpeak", expr, "log x");
    }
    ...
    fn simple_log_with_base() {
        ...
        test("ClearSpeak", expr, "the log base b of x");
    }
    ...
    fn explicit_times_with_parens() {
        let expr = "<math><mrow><mi>t</mi><mo>&#x2062;</mo><mrow><mo>(</mo><mi>x</mi><mo>)</mo></mrow></mrow></math>";
        test("ClearSpeak", expr, "t times x");
    }
    ...
    fn times_following_paren() {
        ...
        test("ClearSpeak", expr, "2 times 3");
    }
    ...
    fn no_times_sqrt() {
        ...
        test("ClearSpeak", expr, "the square root of eigh; the square root of b; equals, the square root of eigh b,");
    }
  ...
  <mo>)</mo></mrow>
     ...
     */
     ...
     fn no_parens_negative_number() {
         ...
         test("ClearSpeak", expr, "2 plus negative 2");
     }
     ...
     fn no_parens_negative_number_with_var() {
         ...
         test("ClearSpeak", expr, "negative 2 x");
     }
     ...
     fn parens_superscript() {
         ...
         test("ClearSpeak", expr, "open paren 2 x close paren squared");
     }

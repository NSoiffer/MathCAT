...
#[test]
fn ex_5_13() {
    let expr= r#"<math><mrow><mstyle mathvariant='bold' mathsize='normal'><mi><mi>r</mi></mi></mstyle><mo>&#x00B7;</mo><mstyle mathvariant='bold' mathsize='normal'><mi><mi>n</mi></mi></mstyle><mo>=</mo><mstyle mathvariant='bold' mathsize='normal'><mi><mi>s</mi></mi></mstyle><mo>&#x00B7;</mo><mstyle mathvariant='bold' mathsize='normal'><mi><mi>n</mi></mi></mstyle></mrow></math>"#;
    test_braille("Swedish", expr, "⠨⠗⠨⠻⠄⠨⠝⠀⠶⠀⠨⠎⠨⠻⠄⠨⠝");
}
#[test]
fn ex_5_14() {
...
#[test]
fn ex_6_21() {
    let expr= r#"<math><mrow><mo>(</mo><mtable equalrows='true' equalcolumns='true'><mtr><mtd><mi>n</mi></mtd></mtr><mtr><mtd><mi>k</mi></mtd></mtr></mtable><mo>)</mo>
...
#[test]
fn ex_7_24() {
    let expr= r#"<math><mrow><mmultiscripts><munder accentunder='true'><mover accent='true'><mi>x</mi><mo>&#x00AF;</mo></mover><mo>&#x00AF;</mo></munder><mi>a</mi><mi>b</mi>

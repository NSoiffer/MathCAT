...
fn trig_names() {
    ...
    test("SimpleSpeak", expr, "sine of x plus cosine of y plus tangent of z plus secant of alpha, plus co-secant of phi, plus co-tangent of phi");
}
...
fn hyperbolic_trig_names() {
    ...
    test("SimpleSpeak", expr, "hyperbolic sine of x, plus \
...
fn inverse_trig() {
    ...
    test("SimpleSpeak", expr, "inverse sine of x");
}

#[test]
fn trig_squared() {
    let expr = "<math><msup><mi>sin</mi><mn>2</mn></msup><mi>x</mi></math>";
    test("SimpleSpeak", expr, "sine squared of x");
}

#[test]
fn trig_cubed() {
    let expr = "<math><msup><mi>tan</mi><mn>3</mn></msup><mi>x</mi></math>";
    test("SimpleSpeak", expr, "tangent cubed of x");
}

#[test]
fn trig_fourth() {
    let expr = "<math><msup><mi>sec</mi><mn>4</mn></msup><mi>x</mi></math>";
    test("SimpleSpeak", expr, "the fourth power of, secant of x");
}
...
fn trig_power_other() {
    ...
    test("SimpleSpeak", expr, "the n minus 1 power of, hyperbolic sine of x");
}

#[test]
fn simple_log() {
    let expr = "<math> <mrow>  <mi>log</mi><mi>x</mi></mrow> </math>";
    test("SimpleSpeak", expr, "log x");
}
...
fn simple_log_with_base() {
    ...
    test("SimpleSpeak", expr, "the log base b of x");
}
...
fn simple_ln() {
    ...
    test("SimpleSpeak", expr, "natural log x");
}
...
fn explicit_times_with_parens() {
    let expr = "<math><mrow><mi>t</mi><mo>&#x2062;</mo><mrow><mo>(</mo><mi>x</mi><mo>)</mo></mrow></mrow></math>";
    test("SimpleSpeak", expr, "t times x");
}
...
fn times_following_paren() {
    ...
    test("SimpleSpeak", expr, "2 times 3");
}
...
fn no_times_sqrt() {
    ...
    test("SimpleSpeak", expr, 
            "the square root of eigh; the square root of b; equals, the square root of eigh b end root,");
}
...
/*
    ...
    */
    ...
    fn no_parens_negative_number() {
        ...
        test("SimpleSpeak", expr, "2 plus negative 2");
    }
    ...
    fn no_parens_negative_number_with_var() {
        ...
        test("SimpleSpeak", expr, "negative 2 x");
    }
    ...
    fn parens_superscript() {
        ...
        test("SimpleSpeak", expr, "open paren 2 x close paren squared");
    }

...
fn complex() {
    ...
    test("SimpleSpeak", expr, "the complex numbers");
}
...
fn rationals() {
    ...
    test("SimpleSpeak", expr, "the rational numbers");
}
...
fn reals() {
    ...
    test("SimpleSpeak", expr, "the real numbers");
}
...
fn integers() {
    ...
    test("SimpleSpeak", expr, "the integers");
}
...
fn msup_positive_integers() {
    ...
    test("SimpleSpeak", expr, "the positive integers");
}
...
fn msup_negative_integers() {
    ...
    test("SimpleSpeak", expr, "the negative integers");
}
...
fn msup_positive_rationals() {
    ...
    test("SimpleSpeak", expr, "the positive rational numbers");
}
...
fn msup_negative_rationals() {
    ...
    test("SimpleSpeak", expr, "the negative rational numbers");
}
...
fn empty_set() {
    ...
    test("SimpleSpeak", expr, "the empty set");
}
...
fn single_element_set() {
    ...
    test("SimpleSpeak", expr, "the set 12");
}
...
fn multiple_element_set() {
    ...
    test("SimpleSpeak", expr, "the set 5 comma 10 comma 15");
}
...
fn set_with_colon() {
    ...
    test("SimpleSpeak", expr, "the set of all x such that x is greater than 2");
}
...
fn element_alone() {
    ...
    test("SimpleSpeak", expr, "3 plus 2 i, is not an element of, the real numbers");
}
...
fn complicated_set_with_colon() {
    ...
    test("SimpleSpeak", expr, "the set of all x an element of the integers such that 2 is less than x is less than 7");
}

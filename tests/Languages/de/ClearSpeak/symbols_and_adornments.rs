...
fn multiplication_cross() {
    ...
    test_ClearSpeak("de", "ClearSpeak_MultSymbolX", "Cross", expr, "u cross v");
}
...
fn ellipses_auto_start() {
    ...
    test("de", "ClearSpeak", expr, "dot dot dot comma, negative 2 comma, negative 1 comma, 0");
}
...
fn ellipses_auto_end() {
    ...
    test_ClearSpeak("de", "ClearSpeak_Ellipses", "Auto", expr, "1 comma, 2 comma, 3 comma, dot dot dot");
}
...
fn ellipses_and_so_on_start() {
    let expr = "<math>
        ...
        test_ClearSpeak("de", "ClearSpeak_Ellipses", "AndSoOn", expr, "dot dot dot comma, negative 2 comma, negative 1 comma, 0");
}
...
fn ellipses_and_so_on_end() {
    ...
    test_ClearSpeak("de", "ClearSpeak_Ellipses", "AndSoOn", expr, "1 comma, 2 comma, 3 and so on");
}

...
fn menclose_actuarial() {
    ...
    test("sv", "ClearSpeak", expr, "actuarial symbol, enclosing 3 plus 2 i end enclosure,");
}
...
fn menclose_box() {
    ...
    test("sv", "ClearSpeak", expr, "box, circle, enclosing 3 plus 2 i end enclosure,");
}
...
fn menclose_left() {
    ...
    test("sv", "ClearSpeak", expr, "line on left, enclosing 3 halves end enclosure,");
}
...
fn menclose_right() {
    ...
    test("sv", "ClearSpeak", expr, "line on right, enclosing 3 halves end enclosure,");
}
...
fn menclose_top_bottom() {
    ...
    test("sv", "ClearSpeak", expr, "line on top, bottom, enclosing 3 halves end enclosure,");
}
...
fn menclose_updiagonalstrike() {
    ...
    test("sv", "ClearSpeak", expr, "up diagonal, cross out, enclosing 3 halves end enclosure,");
}
...
fn menclose_downdiagonalstrike() {
    ...
    test("sv", "ClearSpeak", expr, "down diagonal, cross out, enclosing 3 halves end enclosure,");
}
...
fn menclose_cross_out() {
    ...
    test("sv", "ClearSpeak", expr, "x, cross out, enclosing 3 halves end enclosure,");
}
...
fn menclose_vertical_horizontal_strike() {
    ...
    test("sv", "ClearSpeak", expr, "vertical, horizontal, cross out, enclosing 3 halves end enclosure,");
}
...
fn menclose_leftarrow() {
    ...
    test("sv", "ClearSpeak", expr, "left arrow, enclosing 3 halves end enclosure,");
}
...
fn menclose_right_up_down_arrow() {
    ...
    test("sv", "ClearSpeak", expr, "up arrow, down arrow, right arrow, enclosing 3 halves end enclosure,");
}
...
fn menclose_northeastarrow() {
    ...
    test("sv", "ClearSpeak", expr, "northeast arrow, enclosing 3 halves end enclosure,");
}
...
fn menclose_other_single_arrows() {
    ...
    test("sv", "ClearSpeak", expr, "southeast arrow, southwest arrow, northwest arrow, enclosing 3 halves end enclosure,");
}
...
fn menclose_northwestsoutheastarrow() {
    ...
    test("sv", "ClearSpeak", expr, "double ended down diagonal arrow, enclosing 3 halves end enclosure,");
}
...
fn menclose_other_double_arrows() {
    ...
    test("sv", "ClearSpeak", expr, "double ended vertical arrow, double ended horizontal arrow, double ended up diagonal arrow, enclosing 3 halves end enclosure,");
}
...
fn menclose_madrub() {
    ...
    test("sv", "ClearSpeak", expr, "arabic factorial symbol, enclosing 3 halves end enclosure,");
}
...
fn menclose_phasorangle() {
    ...
    test("sv", "ClearSpeak", expr, "phasor angle, enclosing 3 halves end enclosure,");
}
...
fn menclose_circle_phasorangle() {
    ...
    test("sv", "ClearSpeak", expr, "circle, phasor angle, enclosing 3 halves end enclosure,");
}
...
fn menclose_longdiv() {
    ...
    test("sv", "ClearSpeak", expr, "long division symbol, enclosing 3 halves end enclosure,");
}
...
fn menclose_radical() {
    ...
    test("sv", "ClearSpeak", expr, "square root, enclosing 3 halves end enclosure,");
}
...
fn simple_speak_menclose_top_bottom() {
    ...
    test("sv", "SimpleSpeak", expr, "line on top, bottom, enclosing 3 halves end enclosure,");
}

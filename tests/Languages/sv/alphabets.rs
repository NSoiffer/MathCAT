...
fn special_alphabet_chars() {
  ...
  test("sv", "SimpleSpeak", expr, "fraktur cap h comma fraktur cap c");
...
fn greek() {
    ...
    test("sv", "SimpleSpeak", expr, "cap alpha comma cap omega");
    let expr = "<math> <mi>α</mi><mo>,</mo><mi>ω</mi></math>";
...
fn cap_cyrillic() {
    ...
    test("sv", "SimpleSpeak", expr, "cap a comma cap ya");
}

#[test]
fn parenthesized() {
    let expr = "<math> <mi>⒜</mi><mo>,</mo><mi>⒵</mi></math>";
    test("sv", "SimpleSpeak", expr, "parenthesized eigh comma parenthesized z");
}

#[test]
fn circled() {
    let expr = "<math> <mi>Ⓐ</mi><mo>,</mo><mi>Ⓩ</mi></math>";
    test("sv", "SimpleSpeak", expr, "circled cap eigh comma circled cap z");
    let expr = "<math> <mi>ⓐ</mi><mo>,</mo><mi>ⓩ</mi></math>";
...
fn fraktur() {
    ...
    test("sv", "SimpleSpeak", expr, "fraktur cap eigh comma fraktur cap y");
...
fn bold_fraktur() {
    ...
    test("sv", "SimpleSpeak", expr, "fraktur bold cap eigh, comma fraktur bold cap z");
...
fn double_struck() {
    ...
    test("sv", "SimpleSpeak", expr, "double struck cap eigh, comma double struck cap y");
...
fn script() {
    ...
    test("sv", "SimpleSpeak", expr, "script cap eigh comma script cap z");
...
fn bold_script() {
    ...
    test("sv", "SimpleSpeak", expr, "script bold cap eigh comma script bold cap z");
...
fn bold() {
    ...
    test("sv", "SimpleSpeak", expr, "bold cap eigh comma bold cap z");
...
fn italic() {
    ...
    test("sv", "SimpleSpeak", expr, "cap eigh comma cap z");
...
fn bold_greek() {
    ...
    test("sv", "SimpleSpeak", expr, "bold cap alpha comma bold cap omega");
...
fn bold_greek_others() {
    ...
    test("sv", "SimpleSpeak", expr, "bold partial derivative, comma bold pi");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("sv", "SimpleSpeak", expr, "bold partial derivative, comma bold pi");
}
...
fn italic_greek_others() {
    ...
    test("sv", "SimpleSpeak", expr, "partial derivative comma pi");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("sv", "SimpleSpeak", expr, "partial derivative comma pi");
}
...
fn turned() {
    ...
    test("sv", "SimpleSpeak", expr, "turned cap f comma turned sans-serif cap y");
  }

#[test]
fn enclosed_numbers() {
  let expr = "<math> <mi>①</mi><mo>,</mo><mi>⑨</mi></math>";
  test("sv", "SimpleSpeak", expr, "circled 1 comma circled 9");
  let expr = "<math> <mi>⑴</mi><mo>,</mo><mi>⑼</mi></math>";

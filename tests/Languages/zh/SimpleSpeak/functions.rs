...
fn trig_names() {
    ...
    test("zh", "SimpleSpeak", expr, "sine x 加 cosine y 加 tangent z 加 secant alpha, 加 cosecant phi, 加 cotangent phi");
}
...
fn hyperbolic_trig_names() {
    ...
    test("zh", "SimpleSpeak", expr, "hyperbolic sine x, 加 \
...
/*
    ...
    */
    ...
    fn no_parens_monomial() {
        ...
        test("zh", "SimpleSpeak", expr, "b x y");
    }
    ...
    fn no_parens_negative_number() {
        ...
        test("zh", "SimpleSpeak", expr, "2 加 負 2");
    }
    ...
    fn no_parens_negative_number_with_var() {
        ...
        test("zh", "SimpleSpeak", expr, "負 2 x 加 1");
    }
    ...
    fn parens_superscript() {
        ...
        test("zh", "SimpleSpeak", expr, "左小括 2 x 右小括 平方");
    }
    ...
    fn no_parens_fraction() {
        ...
        test("zh", "SimpleSpeak", expr, "2 加 2 分之 1");
    }
    ...
    ///// mysterious intent 
    test("zh", "SimpleSpeak",expr, "open interval 從 c 到 d");
}
...
#[test]
    ...
    test("zh", "SimpleSpeak",expr, "closed open interval 從 c 到 d");
}
...
fn parens_interval_open_closed() {
    ...
    test("zh", "SimpleSpeak",expr,"open closed interval 從 c 到 d");
}
...
fn parens_interval_closed_closed() {
    ...
    test("zh", "SimpleSpeak",expr, "closed interval 從 c 到 d");
}
    ...
    test("zh", "SimpleSpeak",expr,
    "open closed interval 從 負 無限大 到 d");
}

...
fn special_alphabet_chars() {
  ...
  test("zh", "SimpleSpeak", expr, "fraktur 大寫 h 逗號 fraktur 大寫 c");
  let expr = "<math> <mi>ℍ</mi><mo>,</mo><mi>ℿ</mi></math>";
  test("zh", "SimpleSpeak", expr, "空心 大寫 h 逗號 空心 大寫 pi");
  let expr = "<math> <mi>ℐ</mi><mo>,</mo><mi>ℳ</mi></math>";
  test("zh", "SimpleSpeak", expr, "草體 大寫 i 逗號 草體 大寫 m");
}

#[test]
fn greek() {
    let expr = "<math> <mi>Α</mi><mo>,</mo><mi>Ω</mi></math>";
    test("zh", "SimpleSpeak", expr, "大寫 alpha 逗號 大寫 omega");
    let expr = "<math> <mi>α</mi><mo>,</mo><mi>ω</mi></math>";
    test("zh", "SimpleSpeak", expr, "alpha 逗號 omega");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "空心 大寫 delta 逗號 空心 大寫 upsilon");
    let expr = "<math> <mi>α</mi><mo>,</mo><mi>ω</mi></math>";
    test("zh", "SimpleSpeak", expr, "alpha 逗號 omega");
}
...
fn cap_cyrillic() {
    ...
    test("zh", "SimpleSpeak", expr, "大寫 a 逗號 大寫 ya");
}

#[test]
fn parenthesized() {
    let expr = "<math> <mi>⒜</mi><mo>,</mo><mi>⒵</mi></math>";
    test("zh", "SimpleSpeak", expr, "括號圍繞 a 逗號 括號圍繞 z");
}

#[test]
fn circled() {
    let expr = "<math> <mi>Ⓐ</mi><mo>,</mo><mi>Ⓩ</mi></math>";
    test("zh", "SimpleSpeak", expr, "圈圈 大寫 a 逗號 圈圈 大寫 z");
    let expr = "<math> <mi>ⓐ</mi><mo>,</mo><mi>ⓩ</mi></math>";
    test("zh", "SimpleSpeak", expr, "圈圈 a 逗號 圈圈 z");
}

#[test]
fn fraktur() {
    let expr = "<math> <mi>𝔄</mi><mo>,</mo><mi>𝔜</mi></math>";
    test("zh", "SimpleSpeak", expr, "fraktur 大寫 a 逗號 fraktur 大寫 y");
    let expr = "<math> <mi>𝔞</mi><mo>,</mo><mi>𝔷</mi></math>";
    test("zh", "SimpleSpeak", expr, "fraktur a 逗號 fraktur z");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "fraktur 大寫 a 逗號 fraktur 大寫 y");
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
...
fn bold_fraktur() {
    ...
    test("zh", "SimpleSpeak", expr, "fraktur 粗體 大寫 a, 逗號 fraktur 粗體 大寫 z");
    let expr = "<math> <mi>𝖆</mi><mo>,</mo><mi>𝖟</mi></math>";
    test("zh", "SimpleSpeak", expr, "fraktur 粗體 a 逗號 fraktur 粗體 z");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "fraktur 粗體 大寫 a, 逗號 fraktur 粗體 大寫 z");
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
...
fn double_struck() {
    ...
    test("zh", "SimpleSpeak", expr, "空心 大寫 a 逗號 空心 大寫 y");
    let expr = "<math> <mi>𝕒</mi><mo>,</mo><mi>𝕫</mi></math>";
    test("zh", "SimpleSpeak", expr, "空心 a 逗號 空心 z");
    let expr = "<math> <mi>𝟘</mi><mo>,</mo><mi>𝟡</mi></math>";
    test("zh", "SimpleSpeak", expr, "空心 0 逗號 空心 9");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "空心 大寫 a 逗號 空心 大寫 y");
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
...
fn script() {
    ...
    test("zh", "SimpleSpeak", expr, "草體 大寫 a 逗號 草體 大寫 z");
    let expr = "<math> <mi>𝒶</mi><mo>,</mo><mi>𝓏</mi></math>";
    test("zh", "SimpleSpeak", expr, "草體 a 逗號 草體 z");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "草體 大寫 a 逗號 草體 大寫 z");
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
...
fn bold_script() {
    ...
    test("zh", "SimpleSpeak", expr, "粗草體 大寫 a 逗號 粗草體 大寫 z");
    let expr = "<math> <mi>𝓪</mi><mo>,</mo><mi>𝔃</mi></math>";
    test("zh", "SimpleSpeak", expr, "粗草體 a 逗號 粗草體 z");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "粗草體 大寫 a 逗號 粗草體 大寫 z");
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
...
fn bold() {
    ...
    test("zh", "SimpleSpeak", expr, "粗體 大寫 a 逗號 粗體 大寫 z");
    let expr = "<math> <mi>𝐚</mi><mo>,</mo><mi>𝐳</mi></math>";
    test("zh", "SimpleSpeak", expr, "粗體 a 逗號 粗體 z");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "粗體 大寫 a 逗號 粗體 大寫 z");
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
...
fn italic() {
    ...
    test("zh", "SimpleSpeak", expr, "大寫 a 逗號 大寫 z");
    let expr = "<math> <mi>𝑎</mi><mo>,</mo><mi>𝑧</mi></math>";
    test("zh", "SimpleSpeak", expr, "a 逗號 z");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "大寫 a 逗號 大寫 z");
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
...
fn sans_serif_bold_italic() {
    ...
    test("zh", "SimpleSpeak", expr, "粗斜體 大寫 a 逗號 粗斜體 大寫 z");
    let expr = "<math> <mi>𝙖</mi><mo>,</mo><mi>𝙯</mi></math>";
    test("zh", "SimpleSpeak", expr, "粗斜體 a 逗號 粗斜體 z");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "粗斜體 大寫 a 逗號 粗斜體 大寫 z");
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
...
fn bold_greek() {
    ...
    test("zh", "SimpleSpeak", expr, "粗體 大寫 alpha 逗號 粗體 大寫 omega");
    let expr = "<math> <mi>𝛂</mi><mo>,</mo><mi>𝛚</mi></math>";
    test("zh", "SimpleSpeak", expr, "粗體 alpha 逗號 粗體 omega");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "粗體 大寫 alpha 逗號 粗體 大寫 omega");
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
...
fn bold_greek_others() {
    ...
    test("zh", "SimpleSpeak", expr, "粗體 偏微分 逗號 粗體 pi");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "粗體 偏微分 逗號 粗體 pi");
}
...
fn italic_greek_others() {
    ...
    test("zh", "SimpleSpeak", expr, "偏微分 逗號 pi");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "偏微分 逗號 pi");
}
...
fn bold_italic_greek() {
    ...
    test("zh", "SimpleSpeak", expr, "粗斜體 大寫 alpha, 逗號 粗斜體 大寫 omega");
    let expr = "<math> <mi>𝜶</mi><mo>,</mo><mi>𝝎</mi></math>";
    test("zh", "SimpleSpeak", expr, "粗斜體 alpha 逗號 粗斜體 omega");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "粗斜體 大寫 alpha, 逗號 粗斜體 大寫 omega");
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
...
fn bold_italic_greek_others() {
    ...
    test("zh", "SimpleSpeak", expr, "粗斜體 偏微分 逗號 粗斜體 pi");
    // MathType private space versions
    let expr = "<math> <mi></mi><mo>,</mo><mi></mi></math>";
    test("zh", "SimpleSpeak", expr, "粗斜體 偏微分 逗號 粗斜體 pi");
}
...
fn turned() {
    ...
    test("zh", "SimpleSpeak", expr, "翻身 大寫 f 逗號 翻身sanserif 大寫 y");
  }

#[test]
fn enclosed_numbers() {
  let expr = "<math> <mi>①</mi><mo>,</mo><mi>⑨</mi></math>";
  test("zh", "SimpleSpeak", expr, "圈圈 1 逗號 圈圈 9");
  let expr = "<math> <mi>⑴</mi><mo>,</mo><mi>⑼</mi></math>";
  test("zh", "SimpleSpeak", expr, "括號圍繞 1 逗號 括號圍繞 9");
  let expr = "<math> <mi>⒈</mi><mo>,</mo><mi>⒐</mi></math>";
  test("zh", "SimpleSpeak", expr, "1 點 逗號 9 點");
  let expr = "<math> <mi>⓵</mi><mo>,</mo><mi>⓽</mi></math>";
  test("zh", "SimpleSpeak", expr, "雙圈 1 逗號 雙圈 9");
}
